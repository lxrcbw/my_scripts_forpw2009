    ...
    try {
        ...
        const response = await got(url, {
            ...
            headers: {
                ...
                'User-Agent': 'jdapp;android;10.0.2;10;${Date.now()}-${Date.now()};network/wifi;Mozilla/5.0 (Linux; Android 10; ONEPLUS A5010 Build/QKQ1.191014.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/77.0.3865.120 MQQBrowser/6.2 TBS/045230 Mobile Safari/537.36P',
